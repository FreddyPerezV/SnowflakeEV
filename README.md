...
## 📁 Project Structure
/01_setup.sql
/02_file_format_and_stage_validation.sql
/03_bronze_raw_ingestion.sql
/04_bronze_profiling.sql
/05_silver_clean_layer.sql
/06_silver_data_quality.sql
/07_gold_dimensional_model.sql
/08_gold_business_views.sql
/09_sharing_secure_views.sql
/10_semantic_model_prep.sql
/11_monitoring_and_audit.sql
/12_tasks_and_orchestration.sql
/13_bonus_extensions.sql
...
4. Build Gold data model
5. Create views and semantic layer
6. Enable sharing and orchestration
